...
/*
 +----------------------------------------------------------------------------------------+
 | This is a copy of CRM_Case_XMLProcessor_Report (CRM/Case/XMLProcessor/Report.php).     |
 | I changed CRM_Case_XMLProcessor_Report to CRM_Casetopdf_Case_XMLProcessor_Report, and  |
 | copy the function printCaseReport to htmlCaseReport (with a couple of changes)         |
 +----------------------------------------------------------------------------------------+
*/
class CRM_Casetopdf_Case_XMLProcessor_Report extends CRM_Case_XMLProcessor {
...
";
  ...
  function printCaseReport() {
    ...
    $report            = new CRM_Casetopdf_Case_XMLProcessor_Report($isRedact);
  ...
  function htmlCaseReport($caseID, $clientID, $activitySetName = 'standard_timeline', $isRedact = 0, $includeActivities = 1) {
    /*$caseID            = CRM_Utils_Request::retrieve('caseID', 'Positive', CRM_Core_DAO::$_nullObject);
    $clientID          = CRM_Utils_Request::retrieve('cid', 'Positive', CRM_Core_DAO::$_nullObject);
    $activitySetName   = CRM_Utils_Request::retrieve('asn', 'String', CRM_Core_DAO::$_nullObject);
    $isRedact          = CRM_Utils_Request::retrieve('redact', 'Boolean', CRM_Core_DAO::$_nullObject);
